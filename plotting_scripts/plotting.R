...
for(i in patient){
  ...
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 0, r1 = 0.45, x = meth_data$end_position, y = (meth_data[ ,i] / 100), col = meth_color)
  kpAddLabels(kp, labels = "DNAMethylation", side = "left", r0 = 0, r1 = 0.45, srt = 90, label.margin = 0.03)

  kpDataBackground(kp, data.panel = 1, r0=0.5, r1=1)
  kpAxis(kp, r0 = 0.5, r1 = 1, ymin = 0, ymax = (max(gene_data[ ,i]) + 20))
  kpBars(kp, chr = gene_data$chromosome_name, r0 = 0.5, r1 = 1, x0 = gene_data$start_position, x1 = gene_data$end_position, y1 = (gene_data[ ,i] / max(gene_data[ ,i])), border = "slateblue4")
  kpAddLabels(kp, labels = "RNASeq", side = "left", r0 = 0.5, r1 = 1, srt = 90, label.margin = 0.03)
  ...
  kpAddLabels(kp, labels = "FCR_WES", side = "left", r0 = 1.05, r1 = 1.5, srt = 90, label.margin = 0.03)

  kpDataBackground(kp, data.panel = 1, r0=1.55, r1=2)
  kpAxis(kp, r0 = 1.55, r1 = 2, ymin = 0, ymax = (max(gene_data[ ,i]) + 20))
  kpAxis(kp, r0 = 1.55, r1 = 2, ymin = 0, ymax = 5, numticks = 6, side = 2)
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 1.55, r1 = 2, x = meth_data$end_position, y = (meth_data[ ,i] / 100), col = meth_color)
  kpBars(kp, chr = gene_data$chromosome_name, r0 = 1.55, r1 = 2, x0 = gene_data$start_position, x1 = gene_data$end_position, y1 = (gene_data[ ,i] / max(gene_data[ ,i])), border = "slateblue4")
  kpSegments(kp, chr = var_data$chromosome_name,
             r0 = 1.55, r1 = 2,
             x0 = var_data$start_position,
             x1=var_data$start_position,
             y0 = 0, y1=(var_data[ ,i] / 5))
  kpAddLabels(kp, labels = "Integrated table", side = "left", r0 = 1.55, r1 = 2, srt = 90, label.margin = 0.03)
...
for(i in seq(1, length(patient), by = 2)){
  ...
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 0, r1 = 0.45, x = meth_data$end_position, y = ((data_to_visualize / 200) + 0.5), col = col_to_apply)
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 1.55, r1 = 2, x = meth_data$end_position, y = ((data_to_visualize / 200) + 0.5), col = col_to_apply)
  kpAddLabels(kp, labels = "DNAMethylation", side = "left", r0 = 0, r1 = 0.5, srt = 90, label.margin = 0.03)
  
  data_to_visualize = gene_data[ ,patient[i]] - gene_data[ ,patient[i + 1]]
  col_to_apply = ifelse(data_to_visualize > 0, "red4", "blue4")
  
  kpDataBackground(kp, data.panel = 1, r0=0.5, r1=1)
  kpAxis(kp, r0 = 0.5, r1 = 1, ymin = (min(data_to_visualize)), ymax = (max(data_to_visualize)))
  ...
  kpDataBackground(kp, data.panel = 1, r0=1.05, r1=1.5)
  kpAxis(kp, r0 = 1.05, r1 = 1.5, ymin = -5, ymax = 5, numticks = 11)
  ...
  kpSegments(kp, chr = var_data$chromosome_name,
             ...
             y0 = Y0 + 0.5, y1 = Y1 + 0.5,
             col = col_to_apply)
  kpAddLabels(kp, labels = "FCR_WES", side = "left", r0 = 1, r1 = 1.5, srt = 90, label.margin = 0.03)
  kpAddLabels(kp, labels = "Integrated table", side = "left", r0 = 1.5, r1 = 2, srt = 90, label.margin = 0.03)
  dev.off()
}
...
rm(col_to_apply, meth_color, Y0, Y1)