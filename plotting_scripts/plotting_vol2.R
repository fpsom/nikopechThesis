...
for(i in patient){
  ...
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 0, r1 = 0.45, x = meth_data$end_position, y = meth_data[ ,i], col = meth_color)
  ...
  kpAxis(kp, r0 = 0.5, r1 = 1, ymin = 0, ymax = (max(gene_data[ ,i])))
  ...
  kpAddLabels(kp, labels = "Variant", side = "left", r0 = 1.05, r1 = 1.5, srt = 90, label.margin = 0.03)
  ...
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 1.55, r1 = 2, x = meth_data$end_position, y = (meth_data[ ,i]), col = meth_color)
...
for(i in seq(1, length(patient), by = 2)){
  ...
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 0, r1 = 0.45, x = meth_data$end_position, y = ((data_to_visualize / 2) + 0.5), col = col_to_apply)
  kpPoints(kp, chr = meth_data$chromosome_name, r0 = 1.55, r1 = 2, x = meth_data$end_position, y = ((data_to_visualize / 2) + 0.5), col = col_to_apply)
